...
using AVKit;
using Foundation;
using GoogleInteractiveMediaAds;
using ObjCRuntime;
using UIKit;
...
namespace GoogleIMA
{
	...
	partial interface Constants
	{
		...
		byte[] GoogleInteractiveMediaAdsVersionString { get; }
	}
	...
	[DisableDefaultCtor]
	interface IMAAVPlayerContentPlayhead : IIMAContentPlayhead
	{
	...
	[Protocol, Model]
	interface IMAVideoDisplay : IIMAAdPlaybackInfo
	{
